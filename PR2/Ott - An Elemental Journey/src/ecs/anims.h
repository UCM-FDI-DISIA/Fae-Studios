...
public:
	...
	static enum Entities { OTT_ANIM, MELEE_ANIM, RANGE_ANIM, 
		...
		CARTELELEMENTO, LORE_ANIM, FIREBOSS_ANIM, LAMP_ANIM, GRASS_ANIM, SANCTUARY_ANIM, RELIC};
		CARTELELEMENTO, FIREBOSS_ANIM, LAMP_ANIM, GRASS_ANIM, SANCTUARY_ANIM, RELIC };
