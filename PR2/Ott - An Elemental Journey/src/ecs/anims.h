...
public:
	...
	static enum Entities { OTT_ANIM, MELEE_ANIM, RANGE_ANIM, 
		...
		CARTELELEMENTO, CARTELLOOKDOWN, CARTELATAQUE, CARTELPOWERCARTEL, CARTELATAQUECARGADO, CARTELFUEGO, LORE_ANIM, FIREBOSS_ANIM, LAMP_ANIM, GRASS_ANIM, SANCTUARY_ANIM,SHIELD_ANIM, RELIC};
