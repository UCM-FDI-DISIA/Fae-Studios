...
std::vector<std::vector<anims::animDescription>> anims::animations{ott_anims, 
			...
			lifeshard_anims, movimiento_cartel,lampara_cartel,enredadera_cartel, elemento_cartel,lookDown_cartel,ataque_cartel, 
			powerElemento_cartel,
			ataqueCargado_cartel, fuego_cartel, texto_lore, fireboss_anims, lamp, grass, sanctuary,shield, relic_anims, finalBoss_anims };
