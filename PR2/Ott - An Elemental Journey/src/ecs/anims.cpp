...
std::vector<anims::animDescription> anims::finalBoss_anims{ {300, 64,0,0} };
...
std::vector<std::vector<anims::animDescription>> anims::animations{ott_anims, melee_anims, range_anims, slime_anims, earth_attack, earthBossPresent_anims,earthBoss_anims, warning_anims,pause_anims,miniPause_anims, water_attack, waterBoss_anims, lifeshard_anims, finalBoss_anims };
