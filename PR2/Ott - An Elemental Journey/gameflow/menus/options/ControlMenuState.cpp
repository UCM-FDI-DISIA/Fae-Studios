...
ControlMenuState::ControlMenuState(SDLApplication* app) : MenuState(CONTROLS, app->getTexture("mainmenubackground", CONTROLS), app) {
	//Volver
	...
	controles = app->getTexture("playbackground", this->getStateID());
