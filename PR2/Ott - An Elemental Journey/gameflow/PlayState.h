...
public:
	PlayState(int stateID, SDLApplication* app) : GameState(stateID,app) {
		...
		Ground* ground;
		enemy = static_cast<staticEnemy*> (addObject(new staticEnemy(Vector2D(200, 360), app->getTexture("mushroom", stateID), nullptr, 5000, 5, elementsInfo::Earth, 110, 100, Scale(4, 4), this)));
