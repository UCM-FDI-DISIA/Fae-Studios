...
//el filename en mac es ../TPV2/TPV2/resources/config/asteroids.resources.mac.json y en windows es solo resources/config/asteroids.resources.mac.json
...
#ifdef __APPLE__
const std::string jsonRoute = "../TPV2/TPV2/resources/config/sdlutilsdemo.resources.mac.json";
#endif

#ifdef __WINDOWS__
const std::string jsonRoute = "resources/config/sdlutilsdemo.resources.windows.json";
#endif
